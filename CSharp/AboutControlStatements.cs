...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        public void WhyItsWiseToAlwaysUseBrackets()
        {
			...
			Assert.Equal(false, b1); //why wouldn't line 69/70 reset value to true?
        ...
        public void IsOperators()
        {
            ...
            Assert.Equal(true, isAboutControlStatements); //isnt this false because myInstance is an instance of IsOperators
        ...
        {
            int i = 0;
            var result = new List<int>(); // 0 2 4 6 8 
            while(i < 10)
            {
                i += 1;
                if ((i % 2) == 0) { continue; }
